// test_utilities.go
// Mistakes #88, #90, #91: httptest, test helpers, and t.Cleanup
//
// This file contains HTTP handlers and utility functions.
// Your task is to fix the tests in test_utilities_test.go.
